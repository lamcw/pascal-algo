...
begin
   ...
   writeln('===================');
   writeln;
   writeln('1. Input Student Details');
   writeln('2. Input Student Assessment');
   writeln('3. Output Student Details');
   writeln('4. Output Student Assessment');
   writeln('5. Exit');
   ...
   repeat
      Main_Menu(choice);
         case choice of
            ...
            '2': Input_Student_Assessment;
            '3': Output_Student_Details;
            '4': Output_Student_Assessment;
         end;
   until not(choice in ['1','2','3','4']);
